...
def auto_side():
    print('~~Usage:')
    print('~~$python strategy.py')
    print('~~or $python strategy.py LTCUSDT 0.0001 0.001 0.05')
    print('~~Ctrl+C to quit!')
    try:
    ...
    while True:
        ...
        if side == 'left':
            print auto_left_side(pair, amount_ratio, avg_price,
                                 earn_ratio, loss_ratio)
        elif side == 'right':
            print auto_right_side(pair, amount_ratio, avg_price,
                                  earn_ratio, loss_ratio)
        else:
            print('error, running again~')
